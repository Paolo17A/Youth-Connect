...
import '../utils/badge_couter_util.dart';
import '../widgets/custom_styling_widgets.dart';

class OverallLeaderboardScreen extends StatefulWidget {
  const OverallLeaderboardScreen({super.key});

  @override
  State<OverallLeaderboardScreen> createState() =>
      _OverallLeaderboardScreenState();
}

class _OverallLeaderboardScreenState extends State<OverallLeaderboardScreen> {
    ...
    try {
      ...
      eligibleUsers = userDocs.where((doc) {
        ...
        return userData.containsKey('skillsDeveloped') &&
            ...
            countAllBadges(userData['skillsDeveloped']) != 0;
      }).toList();
      setState(() {
        _isLoading = false;
        _isInitialized = true;
